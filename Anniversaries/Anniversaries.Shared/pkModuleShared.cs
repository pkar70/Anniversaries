...
#if NETFX_CORE
            (Windows.UI.Xaml.Application.Current as App).Exit();
#elif __ANDROID__
...
//            //Android.Content.ClipData clipData = Android.Content.ClipData.NewPlainText("mojtekst",sTxt);
...
//            return await oClipCont.GetTextAsync(); //< --nie ma w UNO
            ...
            //#elif __ANDROID__
            //            //var context = Android.App.Application.Context;
            //            //Android.Content.ClipboardManager clipboard = context.GetSystemService(CLIPBOARD_SERVICE);
            //            ////    (Android.Content.ClipboardManager)GetSystemService(context.CLIPBOARD_SERVICE);

            //            //Android.Content.ClipData clipData = clipboard.PrimaryClip;
...
#region "DialogBoxy"
    ...
    public static string GetPlatform()
    {
        ...
        public static string GetAppVers()
        {
...
#elif __ANDROID__
            // manifest ma: android:versionCode="1" android:versionName="1.0"
            var context = Android.App.Application.Context;
            ...
            string sTmp = "??";
            sTmp = info.VersionCode.ToString();
            sTmp = info.VersionName;
            return sTmp;
#elif __IOS__
